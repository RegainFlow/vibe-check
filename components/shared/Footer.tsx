        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start gap-4">
            ...
            <p className="max-w-xs font-mono text-[10px] uppercase tracking-widest text-muted-foreground leading-relaxed">
              AI code audits for non-technical founders. Ensure your codebase is
              ship-ready.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3 mt-2">
                <a
                  ...
                  className="p-2 border border-indigo-900/50 bg-indigo-950/50 rounded-lg text-muted-foreground hover:text-magenta hover:border-magenta transition-all"
                >
                ...
                <a
                  href="https://www.reddit.com/user/Prestigious_Fly_3505"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 border border-indigo-900/50 bg-indigo-950/50 rounded-lg text-muted-foreground hover:text-magenta hover:border-magenta transition-all"
                >
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            >
              <div className="rpg-panel-header absolute top-0 left-0 right-0">
                Origin Signal
              </div>
              ...
              <div className="mt-8 flex flex-col items-center gap-6">
                <div className="size-16 flex items-center justify-center bg-indigo-950 border border-magenta/40 rounded-sm rotate-45 shadow-[0_0_15px_rgba(217,70,239,0.2)]">
                  <div className="-rotate-45 font-mono text-2xl font-bold text-magenta">
                    R
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 font-mono text-[10px] uppercase tracking-widest text-muted-foreground leading-relaxed">
                    Built by RegainFlow — crafting tools that help founders ship
                    with confidence.
                  </p>
                </div>
