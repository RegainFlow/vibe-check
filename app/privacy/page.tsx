      ...
      <main className="pt-32 pb-24 px-4">
        <article className="prose prose-neutral dark:prose-invert max-w-2xl mx-auto">
          ...
          <ul>
            ...
            <li>
              <strong>Repository data</strong> — We clone the public repository
              URL you provide, analyze it in memory, and delete the clone after
              the audit completes. We do not store your source code.
            </li>
            <li>
              <strong>Audit results</strong> — Findings, scores, and generated
          ...
          <p>We use the following third-party services to operate VibeCheck:</p>
          <ul>
            <li>
              <strong>Supabase</strong> — Authentication and database hosting.
            </li>
            <li>
              <strong>OpenAI</strong> — Finding descriptions are rewritten using
              OpenAI&apos;s API. Only finding metadata (category, title, file
              path, code snippet) is sent — never your full source code.
            </li>
            <li>
              <strong>Stripe</strong> — Payment processing (when paid plans are
              available).
            </li>
            <li>
